...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/lib/api/assets.ts"
      ...
      exports: ["getAssets", "getAsset", "approveAsset", "rejectAsset"]
  key_links:
...
- Accept: { checklist?: ChecklistItem[], comments?: string }
- Use workflow/transitions to get next state
- If music in platform_assignment, require platform field: { platform: 'music-vine' | 'uppbeat' | 'both' }
