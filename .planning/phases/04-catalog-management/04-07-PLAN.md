...
- Quick Approve (only for non-music in review state):
  - Calls approve API with auto-checked checklist items (all checked=true)
  - Includes system comment: "Quick approved from asset table"
  - Maintains hybrid checklist+comments pattern from user decision
...
- Quick Approve works for non-music assets in review (with auto-checklist and system comment)
</success_criteria>
