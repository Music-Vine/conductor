...
export default async function StockFootageAssetsPage({ searchParams }: SearchParamsProps) {
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600 dark:text-gray-400">
            Manage stock video footage for Uppbeat
          </p>
        </div>
        <Link href="/assets/upload">
          <Button variant="bold">Upload Stock Footage</Button>
        </Link>
      </div>
