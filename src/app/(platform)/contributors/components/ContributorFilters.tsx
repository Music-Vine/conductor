...
/**
 * Client component for contributor search and filtering.
 ...
 */
export function ContributorFilters({ currentParams }: ContributorFiltersProps) {
  ...
  const handleStatusChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    updateFilters({ status: e.target.value as ContributorStatus | 'all' })
  }
